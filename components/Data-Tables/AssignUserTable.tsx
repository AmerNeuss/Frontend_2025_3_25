...
export default function AssignUserTable({
  ...
  //   }
  // };
  // const columns = getColumns(ProjectId, projectName,fetchUsers);
    ...
    <div className="space-y-4">
      ...
      {/* <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="relative">
            <Input
              ...
              className={cn(
                "peer min-w-60 ps-9",
                Boolean(table.getColumn("username")?.getFilterValue()) && "pe-9"
              )}
              value={
        ...
        <div className="flex items-center gap-3">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="ml-auto text-red-500" variant="outline">
                  ...
                  />
                  Delete
                  <span className="bg-background text-red-500 text-muted-foreground/70 -me-1 inline-flex h-5 max-h-full items-center rounded border px-1 font-[inherit] text-[0.625rem] font-medium">
          ...
          <UserDialog fetchUsers={fetchUsers} ProjectId={ProjectId} projectName={projectName} />
        </div>
      </div> */}
