...
EditConnectionsProps) {
  ...
  //         form.setValue('method', parsedProperty.method || '');
  //         form.setValue('format', parsedProperty.format || '');
  //         form.setValue('address', parsedProperty.address || '');
  //       } else if (deviceData.type === 'S7') {
  //         form.setValue('ip', parsedProperty.ip || '');
  //         form.setValue('port', parsedProperty.port || 0);
  //         form.setValue('slot', parsedProperty.slot || 0);
  //         form.setValue('rack', parsedProperty.rack || 0);
  //       } else if (deviceData.type === 'Database') {
  //         form.setValue('databaseName', parsedProperty.databaseName || '');
  //         form.setValue('username', parsedProperty.username || '');
  //         form.setValue('port', parsedProperty.port || '');

  //         form.setValue('host', parsedProperty.host || '');
  //         form.setValue('dbType', parsedProperty.dbType || '');
  //       }
  //     } catch (err) {
